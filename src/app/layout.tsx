...
})(window,document,'script','dataLayer','GTM-WVP9FZ9V');`}
        </Script>
        {/* Google Analytics (gtag.js) */}
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-CGHYCPVYJH" strategy="afterInteractive" />
        <Script id="ga4" strategy="afterInteractive">
          {`window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-CGHYCPVYJH');`}
        </Script>
      ...
      <body className="bg-white text-slate-900 antialiased">
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WVP9FZ9V"
            height="0"
            width="0"

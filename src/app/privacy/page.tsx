    ...
    <>
      ...
      <main className="min-h-screen bg-white pt-24">
        <article className="mx-auto max-w-3xl px-6 py-20 prose prose-slate">
          <h1 className="text-4xl font-black text-slate-900">Politica de Privacidad</h1>
          ...
          <p>Conforme a la Ley 25.326, usted tiene derecho a acceso, rectificacion, supresion, oposicion y portabilidad de sus datos. Para ejercer estos derechos, escriba a <a href="mailto:contacto@protable.io" className="text-emerald-500 hover:underline">contacto@protable.io</a>.</p>

  ...
  return (
    <section className="bg-slate-900 py-20 md:py-28">
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="text-slate-400 text-lg mb-10">15 dias gratis. Sin tarjeta. Sin contratos.</p>
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a href="/contacto" className="inline-flex items-center gap-2 rounded-full bg-amber-400 hover:bg-amber-500 px-8 py-4 text-lg font-semibold text-slate-900 transition-all hover:scale-105 group">
